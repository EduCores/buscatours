      ...
      >
        ...
        >
          <div style={{ display: "flex", gap: "8px", alignItems: "center", marginBottom: "12px", flexWrap: "wrap" }}>
            ...
            >
              <span style={{ display: "inline-block", width: "4px", height: "4px", borderRadius: "50%", backgroundColor: "#ef4444" }} className="ping-dot"></span>
              {tText('tdViewingOffer', 'ðŸ”¥ 3 personas viendo esta oferta')}
            </span>
      ...
      <div className="container detail-main-container" style={{ marginTop: "-60px", position: "relative", zIndex: 2 }}>
        <div className="detail-grid-layout">
          ...
          <div className="detail-main-column" style={{ display: "flex", flexDirection: "column", gap: "30px", minWidth: 0 }}>
            ...
            >
              <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "6px" }}>
                ...
                <span style={{ fontSize: "0.75rem", color: "var(--text-muted)", fontWeight: 600 }}>{tText('duracion', 'DURACIÃ“N')}</span>
              ...
              <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "6px" }}>
                ...
                <span style={{ fontSize: "0.95rem", fontWeight: 700, color: "var(--text-heading)" }}>{tText('todoElAno', 'Todo el AÃ±o')}</span>
              </div>
              <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "6px" }}>
                <Users size={24} style={{ color: "var(--primary)" }} />
                <span style={{ fontSize: "0.75rem", color: "var(--text-muted)", fontWeight: 600 }}>{tText('edadMinima', 'EDAD MÃNIMA')}</span>
                <span style={{ fontSize: "0.95rem", fontWeight: 700, color: "var(--text-heading)" }}>{tText('edad12', '12+ aÃ±os')}</span>
              </div>
              <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "6px" }}>
                <ShieldAlert size={24} style={{ color: "var(--primary)" }} />
                <span style={{ fontSize: "0.75rem", color: "var(--text-muted)", fontWeight: 600 }}>{tText('pasajerosMax', 'PASAJEROS MÃX.')}</span>
            ...
            <div className="glass-card detail-tab-content" style={{ borderRadius: "var(--radius-md)", minWidth: 0 }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "24px", minWidth: 0 }}>
                  <div>
                    ...
                    <p style={{ color: "var(--text-main)", fontSize: "0.95rem", lineHeight: "1.7" }}>
                      {tour.description} {tText('tdDetailIntro', 'Al iniciar el viaje con Busca Tours, te aseguramos el transporte guiado local por profesionales certificados. Nos enfocamos en la seguridad y la entrega de datos arqueolÃ³gicos, de fauna y flora representativos de cada sector.')}
                    </p>
                  </div>
                    ...
                    <div style={{ display: "flex", gap: "20px", alignItems: "center", flexWrap: "wrap" }}>
                      <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
                        ...
                        <span style={{ fontSize: "0.75rem", fontWeight: 700, color: "var(--text-muted)" }}>
                          4.9â­ ({tour.reviewsCount + 10} {tText('reviews', 'reseÃ±as')})
                        </span>
                      </div>
                  ...
                  <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(250px, 1fr))", gap: "30px" }}>
                    ...
                    <div>
                      ...
                      <ul style={{ listStyle: "none", display: "flex", flexDirection: "column", gap: "10px", fontSize: "0.9rem" }}>
                        <li style={{ display: "flex", gap: "8px", alignItems: "center" }}><Check size={14} style={{ color: "var(--primary)" }} /> {tText('tdCertGuide', 'GuÃ­a local certificado (EspaÃ±ol/InglÃ©s)')}</li>
                        ...
                        <li style={{ display: "flex", gap: "8px", alignItems: "center" }}><Check size={14} style={{ color: "var(--primary)" }} /> {tText('tdIncludeLunch', 'Box Lunch premium e hidrataciÃ³n')}</li>
                    ...
                    <div>
                      ...
                      <ul style={{ listStyle: "none", display: "flex", flexDirection: "column", gap: "10px", fontSize: "0.9rem" }}>
                        ...
                        <li style={{ display: "flex", gap: "8px", alignItems: "center" }}><X size={14} style={{ color: "var(--accent)" }} /> {tText('tdExcludeTips', 'Propinas para el guÃ­a / chofer')}</li>
                        <li style={{ display: "flex", gap: "8px", alignItems: "center" }}><X size={14} style={{ color: "var(--accent)" }} /> {tText('tdExcludeGear', 'Equipamiento de montaÃ±a personal')}</li>
              ...
              {activeTab === "map" && (
                <div>
                  ...
                  <p style={{ fontSize: "0.9rem", color: "var(--text-muted)", marginBottom: "20px" }}>
                    {tText('tdMapDesc', 'UbicaciÃ³n y recorrido geogrÃ¡fico para la excursiÃ³n a')} {tour.title}.
                  </p>
                  ...
                  >
                    ...
                    <span style={{ position: "absolute", bottom: "16px", left: "20px", fontSize: "0.8rem", color: "var(--text-muted)", zIndex: 10, backgroundColor: "rgba(0,0,0,0.6)", padding: "4px 10px", borderRadius: "20px" }}>
                      {tText('tdMapRoute', 'ðŸŒ Ruta de ExploraciÃ³n DinÃ¡mica')}
                    </span>
                  </div>
                </div>
              )}
              ...
              {activeTab === "photos" && (
                <div>
                  <h3 style={{ fontSize: "1.4rem", marginBottom: "16px" }}>{tText('galeriaFotos', 'GalerÃ­a de Fotos')}</h3>
                  <div
                    style={{
                      display: "grid",
            ...
            >
              ...
              {(() => {
                const getFlexibleDates = () => {
                  ...
                  return [
                    { index: 0, dateStr: d0.toISOString().split("T")[0], display: formatDateStr(d0), discount: 0, label: activeLanguage === "ES" ? "EstÃ¡ndar" : activeLanguage === "PT" ? "PadrÃ£o" : "Standard" },
              ...
              >
                ...
                {/* CompaÃ±ero de viaje ideal integration inside the sidebar form card */}
                <div
                  style={{
                ...
                >
                  <div style={{ display: "flex", flexDirection: "column", gap: "2px" }}>
                    <span style={{ fontSize: "0.78rem", fontWeight: 700, color: "var(--text-heading)", display: "flex", alignItems: "center", gap: "6px" }}>
                      {tText('tdIdealBuddy', 'ðŸ‘¥ CompaÃ±ero de viaje ideal')}
                    </span>
                    <span style={{ fontSize: "0.68rem", color: "var(--text-muted)", lineHeight: "1.3" }}>
                      {tText('tdIdealBuddyDesc', 'Â¿Viajas solo? ConÃ©ctate con otros aventureros interesados en este tour.')}
                    </span>
                  </div>
            ...
            >
              ...
              <p style={{ fontSize: "0.85rem", color: "var(--text-main)", margin: 0 }}>
                {date ? (
                  <span>{tText('tdWeatherDate', 'Para la fecha seleccionada del')} <strong>{date}</strong>, {tText('tdWeatherIndicates', 'el pronÃ³stico indica')} <strong>{weather.desc}</strong> {tText('tdWeatherTemp', 'con temperatura de')} <strong>{weather.temp}</strong>. {weather.tip}</span>
                ) : (
                  <span>                       {tText('tdWeatherSelect', 'Selecciona una fecha en el calendario para calcular el porcentaje de compatibilidad climÃ¡tica en tiempo real.')}</span>
                )}
              </p>
              <div style={{ display: "grid", gridTemplateColumns: "repeat(5, 1fr)", gap: "10px", marginTop: "4px" }}>
                {[
                  ...
                  { day: "MiÃ© 12", temp: "22Â°C", match: "98%", icon: "Sparkles", recommended: true },
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "16px", marginBottom: "24px" }}>
                <div>
                  ...
                  <p style={{ fontSize: "0.85rem", color: "var(--text-muted)", margin: "8px 0 0 0" }}>
                    {tText('socialProofFeedSubtitle', 'Explora fotos y reviews orgÃ¡nicas subidas por viajeros reales en AmÃ©rica. Haz clic en cualquier historia para explorar su recorrido.')}
                  </p>
                </div>
                <button
                  className="btn"
                ...
                >
                  <Icons.Edit3 size={16} /> {tText('tdWriteReview', 'Escribir una valoraciÃ³n')}
                </button>
              </div>
          ...
          <div className="detail-sidebar-column" style={{ display: "flex", flexDirection: "column", gap: "30px" }}>
            ...
            >
              <h4 style={{ fontSize: "1.05rem", fontWeight: 700, color: "var(--text-heading)", marginBottom: "16px" }}>{tText('porQueReservar', 'Â¿Por quÃ© reservar con Busca Tours?')}</h4>
              <ul style={{ listStyle: "none", display: "flex", flexDirection: "column", gap: "12px", fontSize: "0.85rem" }}>
                <li style={{ display: "flex", gap: "8px", alignItems: "center" }}><Check size={14} style={{ color: "var(--primary)" }} /> {tText('confirmacionInmediata', 'ConfirmaciÃ³n inmediata de reserva')}</li>
                ...
                <li style={{ display: "flex", gap: "8px", alignItems: "center" }}><Check size={14} style={{ color: "var(--primary)" }} /> {tText('cancelacionFlexible', 'CancelaciÃ³n flexible (24 horas antes)')}</li>
                <li style={{ display: "flex", gap: "8px", alignItems: "center" }}><Check size={14} style={{ color: "var(--primary)" }} /> {tText('guiasExpertos', 'GuÃ­as locales con aÃ±os de experiencia')}</li>
              </ul>
            </div>
            ...
            >
              <h4 style={{ fontSize: "1.05rem", fontWeight: 700, color: "var(--text-heading)", marginBottom: "12px" }}>{tText('tienesPreguntas', 'Â¿Tienes preguntas?')}</h4>
              <p style={{ fontSize: "0.85rem", color: "var(--text-muted)", marginBottom: "16px" }}>
                {tText('ayudaCoordinar', 'Si necesitas ayuda para esta excursiÃ³n o coordinar un viaje a medida, contÃ¡ctanos:')}
              </p>
      ...
      {showGroupPlanner && (
        <div style={{
          ...
          <div style={{ padding: "20px 24px", borderTop: "1px solid var(--border-color)", display: "flex", gap: "10px" }}>
            <button
              onClick={() => {
                alert("Itinerario compartido guardado. Todos los miembros recibirÃ¡n notificaciones.");
