...
const MOCK_TOURS: Tour[] = [
  ...
  },
  {
    ...
    lat: -20.1338,
    lng: -67.4891,
    heroImages: [import.meta.env.BASE_URL + 'uploads/tours/salar-de-uyuni-card-tour.webp'],
    bgPosition: 'center',
    status: 'PUBLISHED',
    destination: 'Bolivia'
  },
  {
    ...
    lat: -22.9068,
    lng: -43.1729,
    heroImages: [import.meta.env.BASE_URL + 'uploads/tours/rio-de-janeiro-card-tour.webp'],
    bgPosition: 'center',
    status: 'PUBLISHED',
    destination: 'Brasil'
  },
