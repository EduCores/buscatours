          ...
          {MENU_ITEMS.map((item) => {
            ...
            return (
              <button
                ...
                className={`w-full flex items-center gap-3.5 px-3 py-2.5 rounded text-xs font-semibold transition-all duration-200 group relative ${
                  isSelected
              ...
              >
                <IconComponent
                  ...
                  className={`transition-colors duration-200 flex-shrink-0 ${
                    isSelected ? 'text-slate-950' : 'text-slate-400 group-hover:text-slate-200'
                  }`}
                />
