...
export default function AiCopilot({ onAddGeneratedTour }: AiCopilotProps) {
  ...
  const generateMockTour = () => {
    ...
    if (textLower.includes('glaciar') || textLower.includes('hielo') || textLower.includes('patagonia') || textLower.includes('grey')) {
    ...
    } else if (textLower.includes('navegac') || textLower.includes('navegar') || textLower.includes('crucero') || textLower.includes('barco') || textLower.includes('lancha') || textLower.includes('kayak') || textLower.includes('mar') || textLower.includes('isla')) {
      title = 'Expedición Náutica & Navegación Premium';
      location = 'Lagos Andinos, Chile';
      country = 'Chile';
      category = 'Navegación';
      price = 480;
      originalPrice = 580;
      duration = '2 días / 1 noche';
      durationHours = 36;
      mainImage = 'https://images.unsplash.com/photo-1544551763-46a013bb70d5?w=800';
      guideId = 'gd-4';
      vehicleId = 'vh-4';
      lat = -45.8500;
      lng = -73.2500;
      vibeScores = { adrenalina: 60, relax: 70, cultura: 45, familia: 65 };
      description = `Recorrido acuático de alta calidad. Navegación en catamarán con timonel certificado, avistamiento de fauna costera y bahía protegida, con paradas para snorkel y desembarco en islotes vírgenes.`;
    } else if (textLower.includes('montaña') || textLower.includes('cerro') || textLower.includes('andes') || textLower.includes('cumbre') || textLower.includes('cima')) {
      title = 'Ascenso de Montaña & Alta Cordillera';
      ...
      lat = -32.8890;
      lng = -69.8820;
      vibeScores = { adrenalina: 90, relax: 25, cultura: 35, familia: 30 };
      description = `Expedición de altura con ascenso técnico a cerros de más de 4000 msnm. Incluye equipo de alta montaña, arnés, cuerdas y guiado certificado por la federación de andinismo.`;
    } else if (textLower.includes('ciudad') || textLower.includes('urbano') || textLower.includes('metrópoli') || textLower.includes('capital')) {
      title = 'Tour Urbano & Iconos de la Ciudad';
      ...
      duration = '1 día';
      durationHours = 8;
      mainImage = 'https://images.unsplash.com/photo-1519682337058-a94d519337bc?w=800';
      guideId = 'gd-6';
      vehicleId = 'vh-6';
      lat = -34.6037;
      lng = -58.3816;
      vibeScores = { adrenalina: 35, relax: 60, cultura: 80, familia: 70 };
      description = `Recorrido por los barrios emblemáticos, plazas históricas y mercados locales. Transporte privado, guía bilingüe y paradas gastronómicas seleccionadas.`;
    } else if (textLower.includes('histórico') || textLower.includes('historico') || textLower.includes('historia') || textLower.includes('colonial') || textLower.includes('castillo') || textLower.includes('ruina')) {
      title = 'Ruta Histórica & Patrimonio Colonial';
      ...
      duration = '1 día';
      durationHours = 9;
      mainImage = 'https://images.unsplash.com/photo-1583422409516-2895a77efded?w=800';
      guideId = 'gd-7';
      vehicleId = 'vh-7';
      lat = 10.3910;
      lng = -75.4794;
      vibeScores = { adrenalina: 30, relax: 55, cultura: 100, familia: 60 };
      description = `Inmersión en la historia colonial: ciudades amuralladas, iglesias centenarias y castillos restaurados con narración de guías historiadores.`;
    } else if (textLower.includes('relax') || textLower.includes('relaj') || textLower.includes('spa') || textLower.includes('playa') || textLower.includes('wellness') || textLower.includes('masaje')) {
      title = 'Retiro de Relajación & Wellness Costero';
      ...
      duration = '3 días / 2 noches';
      durationHours = 72;
      mainImage = 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800';
      guideId = 'gd-8';
      vehicleId = 'vh-8';
      lat = -34.9670;
      lng = -54.9500;
      vibeScores = { adrenalina: 15, relax: 100, cultura: 40, familia: 75 };
      description = `Experiencia de descanso absoluto: spa frente al mar, yoga al amanecer, alimentación saludable y noches en resort de playa exclusivo.`;
    } else if (textLower.includes('salvaje') || textLower.includes('safari') || textLower.includes('fauna') || textLower.includes('avistamiento')) {
      title = 'Safari Salvaje & Avistamiento de Fauna';
      location = 'Reserva de Fauna, Argentina';
      country = 'Argentina';
      category = 'Salvaje';
      price = 260;
      originalPrice = 320;
      duration = '2 días / 1 noche';
      durationHours = 48;
      mainImage = 'https://images.unsplash.com/photo-1516426122078-c23e76319801?w=800';
      guideId = 'gd-9';
      vehicleId = 'vh-9';
      lat = -39.6000;
      lng = -70.9000;
      vibeScores = { adrenalina: 80, relax: 30, cultura: 50, familia: 55 };
      description = `Expedición en 4x4 por reservas protegidas con avistamiento de fauna nativa, pumas, guanacos y aves. Guía naturalistay equipo de observación.`;
    } else if (textLower.includes('outdoor') || textLower.includes('camping') || textLower.includes('senderismo') || textLower.includes('acampar') || textLower.includes('nature')) {
      title = 'Aventura Outdoor & Camping en la Naturaleza';
      ...
      duration = '2 días / 1 noche';
      durationHours = 48;
      mainImage = 'https://images.unsplash.com/photo-1504851149312-7a1d1d1d1d1d?w=800';
      guideId = 'gd-10';
      vehicleId = 'vh-10';
      lat = -31.9500;
      lng = -64.0500;
      vibeScores = { adrenalina: 65, relax: 50, cultura: 30, familia: 60 };
      description = `Escapada al aire libre con carpa, fogata y senderismo de interpretación ambiental. Incluye equipo de camping completo y ración de marcha.`;
    } else if (textLower.includes('temático') || textLower.includes('tematico') || textLower.includes('parque') || textLower.includes('festival') || textLower.includes('tema')) {
      title = 'Experiencia Temática & Festival Local';
      ...
      duration = '1 día';
      durationHours = 10;
      mainImage = 'https://images.unsplash.com/photo-1539635278303-474b6bf1d33b?w=800';
      guideId = 'gd-1';
      vehicleId = 'vh-1';
      lat = -13.2580;
      lng = -72.2680;
      vibeScores = { adrenalina: 50, relax: 50, cultura: 90, familia: 70 };
      description = `Vive una experiencia inmersiva con temática cultural, festivales locales y talleres artesanales con comunidades originarias.`;
    } else if (textLower.includes('feriado') || textLower.includes('holiday') || textLower.includes('puente') || textLower.includes('festivo')) {
      title = 'Escapada de Feriado & Fin de Semana Largo';
      ...
      duration = '3 días / 2 noches';
      durationHours = 72;
      mainImage = 'https://images.unsplash.com/photo-1499856871958-5b9627545d1a?w=800';
      guideId = 'gd-6';
      vehicleId = 'vh-6';
      lat = -34.4730;
      lng = -57.8440;
      vibeScores = { adrenalina: 40, relax: 70, cultura: 75, familia: 80 };
      description = `Paquete especial para feriados: ciudad patrimonio, gastronomía y paseos en barco, ideal para aprovechar el fin de semana largo.`;
    } else if (textLower.includes('temporada') || textLower.includes('season') || textLower.includes('invierno') || textLower.includes('verano') || textLower.includes('nieve')) {
      title = 'Tour de Temporada & Experiencia de Estación';
      ...
      duration = '4 días / 3 noches';
      durationHours = 96;
      mainImage = 'https://images.unsplash.com/photo-1542601906990-f0fa9a16a601?w=800';
      guideId = 'gd-5';
      vehicleId = 'vh-5';
      lat = -41.1330;
      lng = -71.3100;
      vibeScores = { adrenalina: 70, relax: 55, cultura: 45, familia: 65 };
      description = `Disfruta la temporada alta con actividades según la estación: ski y nieve en invierno, o trekking y lagos en verano.`;
    } else if (textLower.includes('full day') || textLower.includes('full-day') || textLower.includes('día completo') || textLower.includes('dia completo')) {
      title = 'Full Day & Recorrido de Día Completo';
      ...
      duration = '1 día';
      durationHours = 12;
      mainImage = 'https://images.unsplash.com/photo-1469474968028-56623f02e42e?w=800';
      guideId = 'gd-2';
      vehicleId = 'vh-2';
      lat = -33.4480;
      lng = -70.6690;
      vibeScores = { adrenalina: 55, relax: 50, cultura: 70, familia: 75 };
      description = `Itinerario de día completo sin pernoctar: múltiples paradas, almuerzo incluido y regreso en la tarde. Perfecto para aprovechar al máximo el día.`;
    } else if (textLower.includes('lujo') || textLower.includes('luxury') || textLower.includes('premium') || textLower.includes('exclusivo')) {
      title = 'Experiencia de Lujo & Confort Premium';
      ...
      durationHours = 120;
      mainImage = 'https://images.unsplash.com/photo-1505839673365-e3971f8d9184?w=800';
      guideId = 'gd-3';
      vehicleId = 'vh-3';
      lat = -0.7430;
      lng = -90.3100;
      vibeScores = { adrenalina: 45, relax: 90, cultura: 70, familia: 70 };
      description = `Viaje de altísima gama con alojamiento de 5 estrellas, chef privado y experiencias curadas. El máximo confort en cada detalle.`;
    } else if (textLower.includes('familiar') || textLower.includes('familia') || textLower.includes('niños') || textLower.includes('niños') || textLower.includes('family') || textLower.includes('kids')) {
      title = 'Aventura Familiar & Diversión para Todos';
      ...
      duration = '4 días / 3 noches';
      durationHours = 96;
      mainImage = 'https://images.unsplash.com/photo-1503454537195-1dcabb73ffb9?w=800';
      guideId = 'gd-8';
      vehicleId = 'vh-8';
      lat = -27.5950;
      lng = -48.5480;
      vibeScores = { adrenalina: 45, relax: 65, cultura: 55, familia: 100 };
      description = `Diseñado para todas las edades: parques, playas seguras y actividades de baja exigencia física con monitores para niños.`;
    }
