...
export interface Tour {
  ...
  durationDays: number;
  category: 'Outdoor' | 'Relajación' | 'Feriado' | 'Temporada' | 'Salvaje' | 'Aventura' | 'Temático' | 'Cultural' | 'Ciudad' | 'Montaña' | 'Glaciar' | 'Lujo' | 'Histórico' | 'Familiar' | 'Selva' | 'Full Day' | 'Navegación';
  description: string;
  ...
  languages: string[];
  groupType: string;
  availableDates?: Record<string, { status: 'available' | 'booked-out' | 'low-occupancy'; priceMod?: number }>;
}
