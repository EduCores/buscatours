...
- Name: booking-flow.spec.ts >> Búsqueda de tours >> Realiza búsqueda y muestra resultados
- Location: src\__tests__\e2e\booking-flow.spec.ts:26:3
...
Call log:
  - waiting for locator('button:has-text("Búsqueda Tradicional"), button:has-text("Traditional Search")')
